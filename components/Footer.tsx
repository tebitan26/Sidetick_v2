      ...
      <div className="container py-10 grid md:grid-cols-3 gap-8 items-center">
        <div>
          ...
          <div className="mt-5 flex gap-3">
            <a
              href="https://x.com/sidetick_app"
              aria-label="X (Twitter)"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm text-white hover:bg-sidetick.orange hover:text-black transition"
            >
            ...
            <a
              href="https://www.instagram.com/sidetick.app/"
